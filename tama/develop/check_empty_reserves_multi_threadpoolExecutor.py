...
def get_empty_reserves(cfg, date_list, reserves_list, court_link_list, cookies, http_req_num, th_lock_list, th_lock_url):
    """
    ...
    with ThreadPoolExecutor(max_workers=4) as executor:
        ...
        for _resp in as_completed(_days_resp):
            ...
            get_court(res, cfg, _day, th_lock_url)
    ...
    try:
        ...
        while _retry < max_retry:
            if _res.status_code != 200:
                sleep(1)
                _res = requests.post(_search_url, headers=headers, cookies=cookies, timeout=(6.0, 15.0))
                _retry += 1
                ...
                for _exclude_court in cfg['exclude_courts']:
                    if _exclude_court in atag['href']:
                        ...
                        if _match_count >= _exclude_court_count:
                            ...
                            print(atag['href'])
                            print(f'========')
                            th_lock_url.add_url(_day, atag['href'])
